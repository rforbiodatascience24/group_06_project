...
There are four or five replicates of each cell type, that are currently stored as 21 variables all with measures of intensity. We use pivot_longer to lengthen the data so that there is one intensity column and one 'sample' column specifying which replicate and which cell type is referred to. \>\>\>\>\>\>\> 49dfd5c191b02fdac89ee354cc101adffa0353da
...
write_tsv(df_long, "data/02_df_clean.tsv") 
