...
data_location <- "https://www.dropbox.com/scl/fi/xo2tgbhknzelxazhu6qcg/group_6_data_2.zip?rlkey=q0awssn7v4vgi4xfpk2pgl142&st=8x0m2v8d&dl=1"
...
df_mus_musculus <- read_tsv(file = here("data/_raw/uniprotkb_mus_musculus.tsv"), na="NaN")
...
write_tsv(df_mus_musculus, file = here("data/01_dat_load_uniprot_mouse.tsv"))
