...
augmenting_data(df_no_na_long, "hsc", "clp")
...
Therefore we will create four volcanoplots that compare the different stages. CLP will be compared to HSC. CMP will be comared to HSC. And then MEP and GMP will be compared to CMP. In order to prepare the data for these volcanoplots there must be for each pair of compared cell-types be created a variable of log2-fold-change and of q-value. To figure out this data wrangling took quite a bit of effort.
