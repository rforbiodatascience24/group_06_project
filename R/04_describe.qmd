...
df_intensities |> 
  ...
  geom_density() +
  theme_classic()+
  labs(title = "Density of Intensity Prior to Log2 Transformation")
...
df_log_intensities |>
  ...
  geom_density() +
  theme_classic()+
  labs(title = "Density of Intensity After Log2 Transformation")
```
...
df_norm_intensities |> 
  ...
  geom_density() +
  theme_classic()+
  labs(title = "Density of log2-transformed Intensity after Normalization")
```
...
>>>>>>> d11448a68b052bdf726fe5122f9fd3ea3ae5a00d
